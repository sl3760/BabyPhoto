		...
		<div class="container">
			...
			<nav class="collapse navbar-collapse bs-navbar-collapse"
				...
				<ul class="nav navbar-nav navbar-right">
					<li><img src="http://graph.facebook.com/<%=me_id%>/picture"
						alt="me" class="img-rounded"></li>
					<li class="active"><a href="./me.jsp"><%=me_name%></a></li>
					<li>
		...
		<div class="jumbotron">
			...
			<%
				...
				for (Asset asset : assets) {
					...
					out.print("<input type = \"submit\" class=\"btn btn-danger\" value = \"delete\">");
					out.print("<input type=\"hidden\" name = \"fileName\" value = \""
							+ asset.name + "&" + asset.image + "\">");
					out.print("</form>");
					out.println("<div class=\"fb-comments\" data-href=\"http://1.testforsocialgames.appspot.com?"
							+ asset.name
							+ "&"
							+ asset.image
